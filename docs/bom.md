...
At the time of writing, **a Microban robot costs approximately $546**.

If you also include the configuration tools (Dynamixel U2D2 and U2D2 Power Hub), the total cost rises to approximately $597.
