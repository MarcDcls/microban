...
def main() -> None:
    ...
    parser.add_argument("--delay-pos", type=int, default=5, metavar="TICKS", help="Motor position read delay in scheduler ticks (1 tick = 20 ms at 50 Hz)")
    parser.add_argument("--delay-vel", type=int, default=6, metavar="TICKS", help="Motor velocity read delay in ticks")
    parser.add_argument("--delay-gyro", type=int, default=5, metavar="TICKS", help="Gyro read delay in ticks")
    parser.add_argument("--delay-quat", type=int, default=6, metavar="TICKS", help="Quaternion (projected gravity) read delay in ticks")
